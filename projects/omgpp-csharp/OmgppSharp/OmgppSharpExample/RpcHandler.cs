...
namespace Sample.Messages
{
    ...
    public class GameCommandsClientHandler : IGameCommandsClient, IDisposable
    {
        ...
        ulong reqId = 0;
        public GameCommandsClientHandler(OmgppSharpClient.Client client)
        {
            this.client = client;
        ...
        public Task<global::awd.awd.Void> MoveLeft(global::awd.awd.Void message, bool isReliable)
        {
            ...
            client.CallRpc(310292, 0, global::awd.awd.Void.MessageId, bytes, isReliable);
            ...
            client.CallRpc(310292, reqId, global::awd.awd.Void.MessageId, bytes, isReliable);
        ...
        public Task<global::awd.awd.MessageTest> MoveRight(global::awd.awd.Message message, bool isReliable)
        {
            ...
            var bytes = new byte[size];
            message.WriteTo(bytes);
            client.CallRpc(407415, 0, global::awd.awd.Message.MessageId, bytes, isReliable);
            ...
            client.CallRpc(407415, reqId, global::awd.awd.Message.MessageId, bytes, isReliable);
            return taskCompletionSource.Task;
        }
